...
In this simple game, the player must dodge and jump to *squash* enemies for as long as possible. Earning one point for each enemy squashed.

- **Engine**: Godot .NET
- **Renderer**: Forward+

## :video_game: Preview
![Squash the Creeps 3D preview](./squash-the-creeps-final.webp)
